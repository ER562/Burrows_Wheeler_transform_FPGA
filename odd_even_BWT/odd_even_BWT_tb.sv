...
module odd_even_BWT_tb #(
    ...
    int input_data [REAL_INPUT_LENGTH - 1 : 0] = '{"b", "a", "n", "a", "n", "a"};
    int output_data [REAL_INPUT_LENGTH - 1 : 0];
    int expected_data [REAL_INPUT_LENGTH - 1 : 0] = '{"n", "n", "b", "a", "a", "a"};
    int expected_original_line_idx = 2;
    ...
    initial begin
        ...
        $display("Original line idx: %0d   Expected original line idx: %0d", original_line_idx, expected_original_line_idx);
        if(output_data == expected_data && original_line_idx == expected_original_line_idx)begin
